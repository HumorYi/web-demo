$(document).ready(function(){
	...
	$('#tupBtn').on('click',function(){
		if (clickNum > 0) {
            ...
            $('h1.num>span').html(clickNum);
            !clickNum && $('h1.num').html('您的免费抽奖机会已用光！');
		}
		else{
			alert("亲，抽奖次数已用光！");
		}
	...
	function canvasRun(){
		...
		var canvas01=$('#myCanvas01')[0];
		var canvas03=$('#myCanvas03')[0];
		var canvas02=$('#myCanvas02')[0];
...
window.alert = function (str) {
    $('#alterTxt').html(str);
    $('#alertFram').css("display", "block");
    $('#alertFram > ul > li:nth-of-type(3) > input ').click(function () {
